...
{
public:
    void init(AAssetManager *mgr,const char* path_param, const  char* path_bin, int imgsz, bool gpu);
...
class GARIAMAN {
public:
    void init(AAssetManager *mgr,bool use_gpu);
